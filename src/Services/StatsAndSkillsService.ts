...
export class StatService {
	public static async getStats(): Promise<Stat[]> {
		return fetch('/CyberpunkRPG/assets/InterlockSystem/Stats.json')
	...
	public static async getFumbleTable(): Promise<Fumble[]> {
		return fetch('/CyberpunkRPG/assets/InterlockSystem/FumbleTable.json')
	...
	public static async getSkillList(): Promise<SkillList[]> {
		return fetch('/CyberpunkRPG/assets/InterlockSystem/SkillList.json')
