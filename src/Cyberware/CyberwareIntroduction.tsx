		...
		return (
			<div className={animations.FadeInFast + " " + styles.IntroductionSplit}>
				<div>
					...
					alt="Alt Cunningham." src={`${process.env.PUBLIC_URL}/assets/Visuals/Cyberware.webp`} />
				...
				<div className={styles.IntroductionImage}>
					...
					alt="Alt Cunningham. Johnny Silverhand's input." src={`${process.env.PUBLIC_URL}/assets/Visuals/Cyberware.webp`} />
				</div>
			</div>
		);
	}
