			...
			<div className={animations.FadeInFast + " " + styles.SurgeryMain}>
				<div>
					...
					<FadeInPicture mobile="100% 30%" title="d" 
						alt="Surgery is dangerous." src={`${process.env.PUBLIC_URL}/assets/Visuals/Surgery.webp`}
					/>
				...
				<div className={styles.SurgeryImage}>
					<FadeInPicture title="Surgery is dangerous, but normal." alt="Surgery is dangerous." src={`${process.env.PUBLIC_URL}/assets/Visuals/Surgery.webp`} />
				</div>
			</div>
		);
	}
