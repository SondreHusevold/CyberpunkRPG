			...
			<div className={animations.FadeInFast + " " + styles.IntroductionSplit}>
				<div>
                    ...
                    <FadeInPicture mobile="100% 15%" title="s" 
                        alt="Do not forget your humanity." src={`${process.env.PUBLIC_URL}/assets/Visuals/Cyberlimbs.webp`}
                    />
				...
				<div className={styles.IntroductionImage}>
					<FadeInPicture alt="humanity" title="Do not forget your humanity" src={`${process.env.PUBLIC_URL}/assets/Visuals/Cyberlimbs.webp`} />
				</div>
			</div>
		);
	}
