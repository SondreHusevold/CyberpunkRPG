		...
		return (
			<div className={animations.FadeInFast + " " + styles.InterlockIntroduction}>
				<div className={styles.InterlockIntroductionText}>
					<h1>Introduction:</h1>
					<FadeInPicture mobile="100% 13%" title="StandardInterlock" alt="Interlock system" src={`${process.env.PUBLIC_URL}/assets/Visuals/InterlockSystem.webp`}/>
                ...
                <div className={styles.InterlockIntroductionPicture}>
					<FadeInPicture title="StandardInterlock" alt="Interlock system" src={`${process.env.PUBLIC_URL}/assets/Visuals/InterlockSystem.webp`}/>
				</div>
			</div>
		);
	}
