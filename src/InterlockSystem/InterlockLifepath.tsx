		...
		return (
            <div className={animations.FadeInFast + " " + styles.Lifepath}>
                <div className={styles.Explanations}>
                    <h1>Lifepath:</h1>
                    <FadeInPicture mobile="100% 55%" title="Choose your path." alt="Lifepath" src="/CyberpunkRPG/assets/Visuals/Lifepath.webp"/>
                ...
                <div className={styles.Picture}>
                    <FadeInPicture title="Choose your path." alt="Lifepath" src="/CyberpunkRPG/assets/Visuals/Lifepath.webp"/>
                </div>
            </div>
		);
	}
