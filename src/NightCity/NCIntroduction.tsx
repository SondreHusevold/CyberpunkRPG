		...
		return (
			<div className={animations.FadeInFast + " " + styles.NightCityIntroduction}>
				<div className={styles.NightCityIntroductionText}>
					...
					<FadeInPicture mobile="100% 65%" alt="Night City from NCU." title="Night City as seen from NCU." src={`${process.env.PUBLIC_URL}/assets/Visuals/NightCity.webp`} />
				...
				<div>
					<FadeInPicture alt="Night City from NCU." title="Night City as seen from NCU." src={`${process.env.PUBLIC_URL}/assets/Visuals/NightCity.webp`} />
				</div>
			</div>
		);
	}
