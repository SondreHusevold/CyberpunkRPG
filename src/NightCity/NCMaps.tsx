...
interface NightCityMapsProps {
	hasLoaded: (hasLoaded: boolean) => void;
}

class NightCityMaps extends Component<NightCityMapsProps> {
	...
	public render() {
		return (
			<div className={styles.NightCityMaps}>
                ...
                <div onClick={this.openMapInNewWindow} className={styles.MapPicture}>
                    <FadeInPicture hasLoaded={this.props.hasLoaded} title="Map of Night City" alt="Map of Night City" src="assets/Visuals/MapLowRes.webp" />
                </div>
			</div>
		);
	}
