		...
		return (
			<div className={animations.FadeInFast + " " + styles.NightCityIntroduction}>
				<div className={styles.NightCityIntroductionText}>
					...
					<FadeInPicture mobile="100% 30%" title="Map of the US" alt="Map of the United States." src={`${process.env.PUBLIC_URL}/assets/Visuals/MapOfUS.webp`}/>
				...
				<div className={styles.NightCityIntroductionPicture}>
					<FadeInPicture title="Map of the US" alt="Map of the United States." src={`${process.env.PUBLIC_URL}/assets/Visuals/MapOfUS.webp`}/>					
				</div>
			</div>
		);
	}
