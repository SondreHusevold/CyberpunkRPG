		...
		return (
			<div className={animations.FadeInFast + " " + styles.NightCityIntroduction}>
				<div className={styles.NightCityIntroductionText}>
					...
					<FadeInPicture mobile="100% 30%" alt="The Corporate Center." title="The Corporate Center." src={`${process.env.PUBLIC_URL}/assets/Visuals/History.webp`} />
				...
				<div className={styles.NightCityIntroductionPicture}>
					<FadeInPicture alt="The Corporate Center." title="The Corporate Center." src={`${process.env.PUBLIC_URL}/assets/Visuals/History.webp`} />
				</div>
			</div>
		);
	}
