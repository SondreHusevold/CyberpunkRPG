		...
		return (
			<div className={styles.NightCityIntroduction}>
				<div className={styles.NightCityIntroductionText}>
					...
					<img className={styles.FirstSessionPictureMobile + " " + pictureAnimation.PictureMobileOnly} alt="The Corporate Center." title="The Corporate Center." src="assets/Visuals/History.webp"/>
				...
				<div className={styles.NightCityIntroductionPicture}>
					<img className={pictureAnimation.InterlacedPicture} alt="The Corporate Center." title="The Corporate Center." src="assets/Visuals/History.webp"/>
				</div>
			</div>
		);
	}
