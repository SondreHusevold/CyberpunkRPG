...
interface NightCityHistoryProps {
	hasLoaded: (hasLoaded: boolean) => void;
}

class NightCityHistory extends Component<NightCityHistoryProps> {
		...
		return (
			<div className={styles.NightCityIntroduction}>
				<div className={styles.NightCityIntroductionText}>
					...
					<FadeInPicture hasLoaded={this.props.hasLoaded} mobile="100% 30%" alt="The Corporate Center." title="The Corporate Center." src="assets/Visuals/History.webp"/>					
				...
				<div className={styles.NightCityIntroductionPicture}>
					<FadeInPicture hasLoaded={this.props.hasLoaded} alt="The Corporate Center." title="The Corporate Center." src="assets/Visuals/History.webp"/>
				</div>
			</div>
		);
	}
