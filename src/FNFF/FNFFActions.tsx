	...
	public renderAbout = () => {
		return (
			<div className={styles.SingleColumnGrid}>
				<FadeInPicture mobile="100% 50%" title="Action" alt="Action!" src="/CyberpunkRPG/assets/Visuals/Actions.webp"/>
				...
				<div className={splitter.TwoColumnSplit}>
					...
					<div className={styles.ActionPicture}>
						<FadeInPicture title="Three, two, one, ACTION!" alt="Action!" src="/CyberpunkRPG/assets/Visuals/Actions.webp"/>
					</div>
				</div>
			</div>
		)
		...
		return (
			<React.Fragment>
				...
				<img className={styles.LoSPicture + " " + pictureAnimation.InterlacedPicture} style={{ cursor: "pointer" }} 
					onClick={this.openPictureInNewTab} alt="Line of sight" title="Click to remove background." src="/CyberpunkRPG/assets/Visuals/LineOfSight.webp"
				/>
	...
	public renderImage = () => {
		if(this.state.imageAnimation) {
			return <img className={pictureAnimation.InterlacedPicture} style={{ cursor: "pointer" }} 
					onClick={this.toggleImageAnimation} alt="Line of sight" title="Click to remove background." src="/CyberpunkRPG/assets/Visuals/LineOfSight.webp"
					/>
		}
		return <img onClick={this.toggleImageAnimation} style={{ cursor: "pointer" }} alt="Line of sight" src="/CyberpunkRPG/assets/Visuals/LineOfSightNo3D.webp"/>
	}
