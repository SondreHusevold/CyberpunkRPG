	...
	public renderWoundEffects = () => {
		return (
			<div>
                ...
                <p>The Wound section of the Hardcopy Form is used to record damage. For each point of damage taken, check off one box, moving from left to right, top to bottom.</p>
                <p>The top line of this section (marked LIGHT, SERIOUS, CRITICAL, MORTAL, etc.) tells the overall state of the character’s health.</p>
