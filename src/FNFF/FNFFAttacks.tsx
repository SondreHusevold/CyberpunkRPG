	...
	public renderPicture = () => {
		...
		switch (this.state.currentSelection) {
			case AttackMethods.Ranged:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/RangedWeapon.webp`
				break;
			case AttackMethods.Martial:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/MartialArts.webp`
				break;
			case AttackMethods.Melee:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/MeleeWeapons.webp`
				break;
			case AttackMethods.Automatic:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/AutomaticWeapons.webp`
				break;
			case AttackMethods.AoE:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/AoEWeapons.webp`
				break;
			case AttackMethods.Laser:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/LaserWeapon.webp`
				break;
			default:
				url = `${process.env.PUBLIC_URL}/assets/Visuals/FNFF.webp`;
				break;
		}
	...
	public renderSelection = () => {
		...
		return (
			<div className={animations.FadeInFast + " " + styles.FNFFAttacksInformation}>
				...
				<FadeInPicture mobile="100% 0%" title="" alt="Friday Night Firefight" src={`${process.env.PUBLIC_URL}/assets/Visuals/FNFF.webp`}/>
