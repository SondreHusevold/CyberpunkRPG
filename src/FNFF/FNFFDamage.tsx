		...
		return (
			<div className={animations.FadeInFast + " " + styles.FNFFIntroduction}>
				<div className={styles.FNFFIntroductionText}>
                    ...
                    <h1>Hit Location</h1>
                    <img className={styles.FNFFHitLocationMobile} alt="Friday Night Firefight" src={`${process.env.PUBLIC_URL}/assets/Visuals/HitLocations.webp`}/>
				...
				<div className={styles.FNFFIntroductionPicture}>
					<FadeInPicture title="Hit locations" alt="Friday Night Firefight" src={`${process.env.PUBLIC_URL}/assets/Visuals/HitLocations.webp`}/>
				</div>
			</div>
		);
	}
