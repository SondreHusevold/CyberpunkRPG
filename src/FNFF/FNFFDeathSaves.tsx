		...
		return (
			<div className={animations.FadeInFast + " " + styles.FNFFIntroduction}>
				<div className={styles.FNFFIntroductionText}>
					<h1>Death Saves:</h1>
					<FadeInPicture mobile="100% 30%" title="" alt="s" src={`${process.env.PUBLIC_URL}/assets/Visuals/FNFFIntroduction.webp`}/>
				...
				<div className={styles.FNFFIntroductionPicture}>
					<FadeInPicture title="Fail and die." alt="Friday Night Firefight" src={`${process.env.PUBLIC_URL}/assets/Visuals/FNFFIntroduction.webp`}/>
				</div>
			</div>
		);
	}
