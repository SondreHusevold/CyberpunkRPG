		...
		return (
			<div className={animations.FadeInFast + " " + styles.FNFFIntroduction}>
				<div className={styles.FNFFIntroductionText}>
					<h1>Introduction:</h1>
					<FadeInPicture mobile="100% 30%" title="FNFF" alt="Friday Night Firefight" src="/CyberpunkRPG/assets/Visuals/FNFFIntro.webp"/>
				...
				<div className={styles.FNFFIntroductionPicture}>
					<FadeInPicture title="Quite a Friday Night Firefight" alt="Friday Night Firefight" src="/CyberpunkRPG/assets/Visuals/FNFFIntro.webp"/>
				</div>
			</div>
		);
	}
