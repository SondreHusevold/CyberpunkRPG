		...
		return (
			<div className={styles.FNFFIntroduction}>
				<div className={styles.FNFFIntroductionText}>
					<h1>Introduction:</h1>
					<img className={styles.FNFFIntroductionPictureMobile + " " + pictureAnimation.PictureMobileOnly} alt="Friday Night Firefight" src="assets/Visuals/FNFFIntro.webp"/>
				...
				<div className={styles.FNFFIntroductionPicture}>
					<img className={pictureAnimation.InterlacedPicture} alt="Friday Night Firefight" src="assets/Visuals/FNFFIntro.webp"/>
				</div>
			</div>
		);
	}
