		...
		return (
			<div className={animations.FadeInFast + " " + styles.TTIntroduction}>
				<div className={styles.TTIntroductionText}>
					<h1>Death:</h1>
					<FadeInPicture mobile="100% 30%" title="" alt="Don't die please." src={`${process.env.PUBLIC_URL}/assets/Visuals/TraumaTeamDeath.webp`} />
				...
				<div className={styles.TTIntroductionPicture}>
					<FadeInPicture title="Don't die please..." alt="Don't die please." src={`${process.env.PUBLIC_URL}/assets/Visuals/TraumaTeamDeath.webp`} />
				</div>
			</div>
		);
	}
