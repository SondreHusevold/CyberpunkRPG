			...
			<div className={animations.FadeInFast + " " + styles.TTIntroduction}>
				<div className={styles.TTIntroductionText}>
                    ...
                    <div className={styles.TTIntroMobilePicture} >
					    <img title="Trauma Team" alt="Logo" src="/CyberpunkRPG/assets/Visuals/TraumaTeam.webp"/>
                    </div>
				...
				<div className={styles.TTIntroductionPicture}>
					<FadeInPicture title="Logo of Trauma Team International" alt="Logo" src="/CyberpunkRPG/assets/Visuals/TraumaTeam.webp"/>
				</div>
			</div>
		);
	}
