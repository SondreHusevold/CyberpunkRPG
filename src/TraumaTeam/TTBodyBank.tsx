		...
		return (
			<div className={animations.FadeInFast + " " + styles.TTIntroduction}>
				<div className={styles.TTIntroductionText}>
					<h1>The Body Bank:</h1>
					<FadeInPicture mobile="100% 30%" title="AV4" alt="AV4" src="/CyberpunkRPG/assets/Visuals/TraumaTeamAV4.webp"/>
				...
				<div className={styles.TTIntroductionPicture}>
					<FadeInPicture title="Your typical Trauma Team Aerovehicle" alt="AV4." src="/CyberpunkRPG/assets/Visuals/TraumaTeamAV4.webp"/>
				</div>
			</div>
		);
	}
