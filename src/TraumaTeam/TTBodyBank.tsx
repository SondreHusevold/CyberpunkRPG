		...
		return (
			<div className={styles.TTIntroduction}>
				<div className={styles.TTIntroductionText}>
					<h1>The Body Bank:</h1>
					<img className={styles.BodyBankPictureMobile + " " + pictureAnimation.PictureMobileOnly} alt="Logo of Trauma Team International" src="assets/Visuals/TraumaTeamAV4.webp"/>
				...
				<div className={styles.TTIntroductionPicture}>
					<img className={pictureAnimation.InterlacedPicture} alt="Logo of Trauma Team International" src="assets/Visuals/TraumaTeamAV4.webp"/>
				</div>
			</div>
		);
	}
