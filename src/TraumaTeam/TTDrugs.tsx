		...
		return (
			<div className={animations.FadeInFast + " " + styles.TTIntroduction}>
				<div className={styles.TTIntroductionText}>
					<h1>Drugs:</h1>
					<FadeInPicture mobile="100% 50%" title="" alt="Stop it." src={`${process.env.PUBLIC_URL}/assets/Visuals/TTDrugs.webp`}/>
                    { this.renderDrug() }
				...
				<div className={styles.TTIntroductionPicture}>
                    <FadeInPicture alt="Stop it." 
                        title="Stop it. Get some help and a burger from McDonalds®" src={`${process.env.PUBLIC_URL}/assets/Visuals/TTDrugs.webp`}
                    />
				</div>
			</div>
		);
